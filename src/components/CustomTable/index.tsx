...
export default function CustomTable ({ data, customTableColumnsData }: customTablePropType): JSX.Element {
  const [searchText, setSearchText] = useState('')
  const [searchedColumn, setSearchedColumn] = useState('')
  let searchInput: any

  const handleSearch = (selectedKeys: string[], confirm: any, dataIndex: string): void => {
    confirm()
